...
export const metadata: Metadata = {
  title: 'Pesanan Berhasil — Coming Soon',
  description: 'Halaman konfirmasi pesanan akan segera hadir.',
}
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center pt-28 pb-16">
      <div className="max-w-lg mx-auto px-4 text-center">
        ...
        <h1 className="text-3xl sm:text-4xl font-display font-black text-slate-900 tracking-tight mb-4">
          Pesanan Berhasil — Coming Soon
        </h1>
        <p className="text-slate-500 text-lg leading-relaxed mb-8">
          Halaman konfirmasi pesanan akan tersedia saat marketplace kami diluncurkan.
        </p>
        <Link
          href="/"
