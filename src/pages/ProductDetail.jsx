...
export default function ProductDetail() {
    ...
    return (
      <div className="min-h-screen bg-slate-50 pt-28 pb-16 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/catalog" className="inline-flex items-center px-6 py-3 bg-slate-900 text-white font-bold rounded-xl hover:bg-slate-800 transition-colors">
  ...
  return (
    <div className="min-h-screen bg-white pb-16">
      <MetaTags title={`${name} — Dunia Pancing`} description={product.description_en?.slice(0, 160)} />
      ...
      <div className="bg-white border-b border-slate-100 pt-28 pb-3">
        <div className="max-w-7xl mx-auto px-4">
          <nav className="flex items-center gap-1.5 text-[11px] font-semibold text-slate-400">
            ...
            <Link to="/catalog" className="hover:text-slate-600 transition-colors">{t('nav_catalog', lang)}</Link>
            <svg className="w-3 h-3 text-slate-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
            </svg>
            <Link to={`/catalog?category=${product.category}`} className="hover:text-slate-600 transition-colors capitalize">
